```text
   ...
   @@@@@@@@%##*+==+*+**##%##%@@@                             YAML
   @@@@@@@%##*+==++++*####%%@@%%  
    @@@@%##*+====+++*+**####%@@   Specialties.Tech: ........ Cybersecurity, UI/UX
     @@%#%#*+=======++**###*#@%                              Design, QA, Reverse
     @#*+#*+====---====+++**%@%                              Engineering
     %#*+#%+=#=========+*##+*%%   
    +=*+#%#*+==+====+*#@%%##*+#   - Projects & Development ----------------------
    #+*+**#%%%**+++*%%#*++**+*+   Scola Student Game: ...... 2D Educational Sim
     +++++*+*####*+*###%%%%*+++   Gelutinc: ................ Matchmaking Portal
     =++*%%#@*#*+=+**%@%*#*+++     K-DC: .................... Local Data Manager
     =++==++*++=-++++*++==++*++   
     ==========--==========++=    - Contact & Socials --------------------------
     =========----========+++==   GitHub: .................. [github.com/zulpikar](https://github.com/zulpikar)
     =======------======--+*+==   
     ====--------====---==+*++    - GitHub Stats -------------------------------
      ==-------===----==-==++*    Repos: ... 95  | Stars: ................. 342
...
- **Core Languages**: Python, JavaScript, Rust, C++, Kotlin, TypeScript
- **Specialties**: Cybersecurity, Reverse Engineering, UI/UX Design

---

### 🚀 Projects & Development
- **Scola Student Game** - 2D Educational Simulation Game
- **Gelutinc** - Custom Matchmaking Portal
- **K-DC** - Local Data Manager Framework

---

### 📊 GitHub Stats
<!-- Anda bisa menambahkan custom stats generator/card di sini jika mau -->
